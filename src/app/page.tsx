...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          name: "Ana Marković",
          handle: "@anamarkovic",
          testimonial: "Najbolji studio u Rijeci! Jako precizan rad i profesionalna atmosfera.",
          rating: 5,
        ...
        },
        {
          name: "Ivan Horvat",
          handle: "@ivan_tattoo",
          testimonial: "Dugogodišnji sam klijent i uvijek se vraćam. Vrhunska izvedba.",
          rating: 5,
        ...
        },
        {
          name: "Maja Petrović",
          handle: "@majatattoo",
          testimonial: "Komunikacija je bila odlična od samog početka. Preporuka svima!",
          rating: 5,
        ...
        },
        {
          name: "Dino Krnić",
          handle: "@dino_k",
          testimonial: "Savršeno odrađen projekt, jako sam zadovoljan pristupom.",
          rating: 5,
        ...
        },
        {
          name: "Petra Vukić",
          handle: "@petrav",
          testimonial: "Profesionalnost na visokom nivou, hvala ekipi Barbarossa!",
          rating: 5,
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/middle-age-greyhaired-woman-drinking-coffee-sitting-sofa-home-sticking-tongue-out-happy-with-funny-expression-emotion-concept_839833-20319.jpg",
          alt: "Klijent 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/beautiful-asian-woman-witch-costume-looking-through-finger-glasses-smiling-happy-standing-white-background_1258-114914.jpg",
          alt: "Klijent 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/smiley-authentic-woman-posing-medium-shot_23-2149419291.jpg",
          alt: "Klijent 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/stylish-bearded-male-with-tattooed-arms-dressed-shirt-posing-grey-background_613910-2010.jpg",
          alt: "Klijent 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/man-enjoying-holi-with-colored-t-shirt_23-2148337984.jpg",
          alt: "Klijent 5",
        },
      ]}
      marqueeItems={[
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "Stručnost",
          description: "Naši artisti su specijalizirani za razne stilove tetoviranja.",
        },
        {
          title: "Higijena",
          description: "Najviši standardi sterilnosti i sigurnosti za svakog klijenta.",
        },
        {
          title: "Konzistentnost",
          description: "Kvaliteta koju jamčimo pri svakoj tetovaži, od malih motiva do velikih projekata.",
        },
      ]}
      ...
      features={[
        {
          ...
          subtitle: "Svaka tetovaža je unikatna",
          category: "Komunikacija",
          value: "100%",
        },
        {
          id: "2",
          title: "Higijenski standardi",
          subtitle: "Strogo kontrolirani uvjeti",
          category: "Sigurnost",
          value: "A+",
        },
        {
          id: "3",
          title: "Iskustvo",
          subtitle: "Dugogodišnji rad s klijentima",
          category: "Kvaliteta",
          value: "5.0",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Ivan Horvat",
          role: "Dizajner",
          testimonial: "Vrhunska preciznost i vibe. Dolazim opet!",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-cheerful-young-redhead-european-woman-with-braid-dressed-stylish-clothes_273609-9486.jpg",
        },
        {
          id: "2",
          name: "Maja Petrović",
          role: "Student",
          testimonial: "Najljepša tetovaža koju imam, super pristup.",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-elegant-asian-woman-gothic-lace-dress-celebrating-halloween-dressup-as-witch-sendin_1258-114511.jpg",
        },
        {
          id: "3",
          name: "Dino Krnić",
          role: "Programer",
          testimonial: "Studio je broj 1 u Rijeci bez dileme.",
          imageSrc: "http://img.b2bpic.net/free-photo/stylish-man-shirt-holding-phone-looking-sideways-while-receiving-manicure-by-beautician-beauty-salon_613910-20897.jpg",
        },
        {
          id: "4",
          name: "Petra Vukić",
          role: "Medicinska sestra",
          testimonial: "Hvala na strpljenju i savršenom radu.",
          imageSrc: "http://img.b2bpic.net/free-photo/beautiful-young-tattooed-person_23-2149563307.jpg",
        },
        {
          id: "5",
          name: "Tomislav J.",
          role: "Poduzetnik",
          testimonial: "Dugo sam tražio pravog majstora, našao ga ovdje.",
      ...
      faqs={[
        {
          ...
          content: "Javite nam se preko Instagrama ili telefona za dogovor.",
        },
        {
          id: "f2",
          title: "Koja je cijena tetovaže?",
          content: "Cijena ovisi o veličini, detaljima i stilu tetovaže.",
        },
        {
          id: "f3",
          title: "Kako se pripremiti za tetoviranje?",
          content: "Dođite odmorni, siti i hidratizirani.",
        },
      ]}
  ...
  <div id="contact" data-section="contact">
      ...
      buttons={[
        {
          text: "Pošalji upit",
          href: "mailto:barbarossa@studio.hr",
        },
      ]}
    />
  </div>
